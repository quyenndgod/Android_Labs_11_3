...
public class AddRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Cần bind TextInputLayout để hiển thị lỗi đỏ
        layoutRoomId = (TextInputLayout) etRoomId.getParent().getParent();
        layoutRoomName = (TextInputLayout) etRoomName.getParent().getParent();
